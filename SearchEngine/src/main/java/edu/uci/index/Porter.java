...
/*Proclamation: Porter's Algorithm being a standard implementation, Have borrowed with due permissions from: http://ir.dcs.gla.ac.uk/resources/linguistic_utils/porter.java*/
class NewString {
    public String str;
